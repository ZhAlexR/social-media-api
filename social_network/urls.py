...
from social_network.views import PostViewSet, CreateTagView, toggle_like, toggle_dislike
...
urlpatterns = [
    ...
    path("toggle-dislike/post/<int:pk>/", toggle_dislike, name="toggle-dislike"),
